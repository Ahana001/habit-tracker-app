...
export function HabitForm({ formData, setFormData }) {
  const { toggleDialogBox, setToggleDialogBox, setCurrentHabit, currentHabit } =
    ...
    >
      <div className="ModalOverlay">
        <div className="ModalPortalContent">
          ...
          {currentHabit ? (
            <div>
              <p>{currentHabit.name}</p>
              <p>{currentHabit.repeat}</p>
              <p>{currentHabit.time}</p>
            ...
            /> */}
              ...
              {formData.id === "" ? (
                ...
                <button
                  ...
                  onClick={SaveChangesHabitHandler}
                >
                  SAVE CHANGES
                </button>
              )}
